...
const ICONS = {
  ...
  gsap: new URL('../../assets/stack/gsap.svg', import.meta.url).href,
  blender: new URL('../../assets/stack/blender.svg', import.meta.url).href,
...
const TECH_NODES = [
  ...
  { id: 'gsap', label: 'GSAP', role: 'Animation', icon: ICONS.gsap, color: '#88CE02', x: 0.45, y: 0.15 },
  { id: 'vite', label: 'Vite', role: 'Bundler', icon: ICONS.vite, color: '#646CFF', x: 0.45, y: 0.5 },
  { id: 'blender', label: 'Blender', role: '3D Rendering', icon: ICONS.blender, color: '#F5792A', x: 0.6, y: 0.85 },
